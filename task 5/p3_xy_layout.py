...
for airport in dataset['nodes']:
    ...
    G.add_node(airport_code, importance=importance_factor, x=airport['posx'], y=airport['posy'])
...
# Display the sliders and graph
display(min_importance_slider, min_weight_slider)
