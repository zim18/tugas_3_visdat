...
for airport in dataset['nodes']:
    ...
    G.add_node(airport_code, importance=importance_factor, latitude=airport['latitude'], longitude=airport['longitude'], id=airport['id'], name=airport['name'], city=airport['city'], country=airport['country'], posx=airport['posx'], posy=airport['posy'], state=airport['state'])
